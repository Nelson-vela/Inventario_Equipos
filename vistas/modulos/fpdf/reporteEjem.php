...
//$this->Image('vistas/img/plantilla/icono .png' , 20 ,8, 23 , 18,'PNG');
		...
		$this->Text(50,40,utf8_decode('ACTA DE ENTREGA DE DISPOSITIVOS INFORMÁTICO'),0,'C', 0); 
...
$pdf->MultiCell(175,6,utf8_decode("Siendo ".date('d')." de ".$meses[date('n')-1]. " del ".date('Y').' y habiendose realizado la verificación de los equipos realizados, previo realización de las pruebas necesarias y de no haber observaciones a los trabajos realizados, hacemos entrega de los siguientes equipos. Siendo'),0,'J');
...
/*	$pdf->Cell(30,15,utf8_decode($value['alias']),1,0,'C');	*/
	...
	$pdf->Cell(38,10,utf8_decode($fecha_mantenimientos),1,0,'C');
