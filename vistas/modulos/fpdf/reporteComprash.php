...
class PDF extends FPDF{
      ...
      function Header(){
            ...
            // Logo
            $this->Image('vistas/img/plantilla/icono .png',5,5,35,35);
...
// Salto de línea
           ...
           /* // Salto de línea
            ...
            // Movernos a la derecha
            $this->Cell(5);
            $this->Cell(15,10,'Fecha Emision: ',0,0,'L');
            ...
            // Movernos a la derecha
            $this->Cell(45);
            $this->Cell(25,10,'Fecha Almacenamiento: ',0,0,'L');
     ...
     /// $this->Cell(15,10,utf8_decode($this->row['PEVE_chPLAZOV']),0,0,'L');*/
           ...
           $this->Cell(14,10,utf8_decode('PRODUCTO'),0,0,'L');
           ...
           $this->SetFont('Arial','B',10);
           $this->Cell(12,10,utf8_decode('CANTIDAD'),0,0,'L');
...
// Pie de página
     function Footer()
     {
      ...
      $this->SetFont('Arial','B',8);
      $this->Cell(130,4,utf8_decode('Total General S/'),0,0,'R');
...
function plot_table($widths, $lineheight,$i,$border=0, $aligns=array(), $fills=array(), $links=array()){
  ...
  //foreach ($compraspro as $key3 => $valueProdC) {  
    ...
    foreach ($comprasproCC as $key => $prodLis ) { 
      ...
      $this->Cell(80,10,utf8_decode($prodLis["titulo"].''),0,0,'L');  
